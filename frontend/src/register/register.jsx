...
import { Compass, User, Mail, KeyRound } from 'lucide-react';
    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-100 to-slate-300 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500">
      <Card className="mx-auto max-w-md w-full shadow-lg border border-gray-200 dark:border-gray-700 bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm transition-all duration-300">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardTitle className="text-2xl font-bold font-headline text-gray-900 dark:text-gray-100">Create an Account</CardTitle>
        ...
        <CardContent>
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="full-name" className="text-gray-800 dark:text-gray-300">Full name</Label>
          ...
          <div className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/login" className="underline hover:text-blue-600 dark:hover:text-blue-400">
              Sign in
            </Link>
          </div>
        </CardContent>
